...
def parse_arguments():
    ...
    parser.add_argument('--output_excel', type=str, default='Score_Final_Modified6.xlsx', help='Output Excel file name.')
    parser.add_argument('--total_images', type=int, default=5, help='Total number of images to process.')
    parser.add_argument('--num_cycles', type=int, default=6, help='Number of question-answer cycles.')
