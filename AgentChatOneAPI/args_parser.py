...
def parse_arguments():
    ...
    parser.add_argument('--total_images', type=int, default=590, help='Total number of images to process.')
    parser.add_argument('--num_cycles', type=int, default=5, help='Number of question-answer cycles.')
