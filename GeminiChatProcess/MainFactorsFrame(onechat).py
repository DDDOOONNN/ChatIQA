...
def main():
        ...
        "parts": [
            ...
            },
            {
                "text": (
                    ...
                    "I will use these factors as a consistent framework for evaluating image quality in all future conversations."
                )
            }
        ]
    }
    ...
    for i in tqdm(range(1, total_images + 1), desc="Processing Images"):
        ...
        print(f"Checking image: {image_path}")  # 打印正在检查的图像路径
        ...
        if os.path.exists(image_path):
            try:
                ...
                img_data_uri = GetImage(image_path)
        ...
        for attempt in range(1, max_retries + 1):
            try:
                ...
                # 将助手的响应添加到初始内容中，以维护上下文
                initial_content["parts"].append({
