            ...
            try:
                ...
                user_message_score = {
                    "parts": [
                        {
                            "text": (
                                f"Based on our previous analysis of the two images, ComparisonIMG has been given a quality score of 67. The evaluation criteria include, but are not limited to, the following aspects:{initial_assistant_response}"
